...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  0, PIO_MULTI, (PER_ATTR_DRIVE_STD), (PIN_ATTR_DIGITAL), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_0, GCLK_CCL_NONE  }, // 

  // 1 - SERCOM1 - PA01 - RX and GPIO
  { PORTA,  1, PIO_SERCOM, (PER_ATTR_DRIVE_STD), (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), TCC2_CH1, No_ADC_Channel, EXTERNAL_INT_1, GCLK_CCL_NONE },  // TCC0/WO[0]
  ...
  // 8 - PA06 -  RTS SERCOM0
  { PORTA,  6, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_6, GCLK_CCL_NONE }, // 
  
  // 9 - PA07 -  CTS SERCOM0
  { PORTA,  7, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_7, GCLK_CCL_NONE }, // TCC0/WO[1]
...
//Serial1
  // 19 - TX SERCOM0 - A1
  { PORTA,  4, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_4, GCLK_CCL_NONE }, // ADC/AIN[0]

  // 20 - RX SERCOM0 - A2
  { PORTA,  5, PIO_SERCOM, (PER_ATTR_DRIVE_STD|PER_ATTR_SERCOM_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_5, GCLK_CCL_NONE }, // ADC/AIN[0]
...
Uart Serial1( &sercom0, PIN_SERIAL1_RX, PIN_SERIAL1_TX, PAD_SERIAL1_RX, PAD_SERIAL1_TX, PIN_SERIAL1_RTS, PIN_SERIAL1_CTS ) ;
